...
Функция СлужебныеДанныеСценариев(Параметры) Экспорт
	...
	Результат.Вставить("АдресСлужебныеДанныеСценариев", АдресСлужебныеДанныеСценариев);
	Результат.Вставить("АдресКешСнипетовИменСценариевИменСценариев", АдресКешСнипетовИменСценариевИменСценариев);
