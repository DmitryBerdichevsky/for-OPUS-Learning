...
Процедура НастроитьЭлементыПоставитьНаКонтрольВФормеЭлемента(Форма, ОбъектКонтроля, ИмяГруппыФормы) Экспорт
	...
	УстановитьЗначенияРеквизитовКонтроляВФорме(Форма, СпискиКонтроля);
...
Процедура НастроитьЭлементыПоставитьНаКонтрольВФормеСписка(Форма, СпискиДляВыводаКомандКонтроля) Экспорт
	...
	УстановитьЗначенияРеквизитовКонтроляВФорме(Форма, СпискиКонтроля, Ложь);
...
// Получает массив объектов контроля, по данным выделенных строк динамического списка
//
// Параметры:
//  ИзменяемыеСтрокиСписка - Массив - состоит из структура.
//
// Возвращаемое значение:
//   Массив
//
...
Процедура УстановитьЗначенияРеквизитовКонтроляВФорме(Форма, СпискиКонтроля, УчитыватьСтатус = Истина)
	
	Форма.СпискиКонтроля.Очистить();
	
	Для Каждого ДанныеСпискаКонтроля Из СпискиКонтроля Цикл
		
		НоваяСтрока = Форма.СпискиКонтроля.Добавить();
