...
//
Функция ПодобратьВерсиюИсправленияДляОшибки(Владелец, Обнаружена, ВеткаОбнаружения, СборкаОбнаружения, СрочностьИсправления) Экспорт
		
	ВерсияИсправления = 
		Справочники.Ошибки.ВерсияИсправления(Владелец, Обнаружена, ВеткаОбнаружения, СборкаОбнаружения, СрочностьИсправления, Ложь, 
