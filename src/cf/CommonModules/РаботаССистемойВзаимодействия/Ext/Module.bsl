...
//
Процедура ДобавитьСообщениеПоОбъекту(СсылкаНаОбъект, ПользовательПолучательСообщения, ПользовательАвторСообщения, ЗаголовокОбсуждения, ТекстСообщения) Экспорт
...
Процедура ДобавитьСообщениеОбсуждения(ИдентификаторОбсуждения, ТекстСообщения, ИдентификаторыПолучателей, ИдентификаторАвтора, Действия = Неопределено) Экспорт
	...
	Для Каждого ИдентификаторПолчателя из ИдентификаторыПолучателей Цикл
		СообщениеОбсуждения.Получатели.Добавить(ИдентификаторПолчателя);
	КонецЦикла;
