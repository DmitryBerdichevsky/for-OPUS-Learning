...
Процедура ДобавитьФактическиеИнтервалы(Диаграмма, Точка, Серия, СтрокаДерева)
	...
	Для Каждого СтрокаТаблицы из СтрокаДерева.Строки Цикл
		...
		Если СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыКонтрольныхТочекТехническихПроектов.Пропущена
			Или СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыЗадачПроцессов.Отменена Тогда
			Продолжить;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(СтрокаТаблицы.СрокПрохожденияКонтрольнойТочки) Тогда
			...
			Если СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыКонтрольныхТочекТехническихПроектов.Назначена
				Или СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыЗадачПроцессов.Запланирована
			...
			ИначеЕсли СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыКонтрольныхТочекТехническихПроектов.Пройдена
				Или СтрокаТаблицы.СтатусКонтрольнойТочки = Перечисления.СтатусыЗадачПроцессов.Выполнена Тогда
...
Функция ПолучитьСтруктуруФактическогоИнтервала(СтрокаДерева, СтрокиТаблицы)
	...
	Для Каждого СтрокаТаблицы из СтрокиТаблицы Цикл
		...
		Если СтрокаТаблицы.СтатусКонтрольнойТочки = ПредопределенноеЗначение("Перечисление.СтатусыКонтрольныхТочекТехническихПроектов.Пропущена")
			Или СтрокаТаблицы.СтатусКонтрольнойТочки = ПредопределенноеЗначение("Перечисление.СтатусыЗадачПроцессов.Отменена") Тогда
			Продолжить;
		КонецЕсли;
	...
	Если ЗначениеЗаполнено(СрокПоследнейУказаннойКонтрольнойТочки) Тогда
		Если Статус = ПредопределенноеЗначение("Перечисление.СтатусыКонтрольныхТочекТехническихПроектов.Пройдена")
			Или Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗадачПроцессов.Выполнена") Тогда
