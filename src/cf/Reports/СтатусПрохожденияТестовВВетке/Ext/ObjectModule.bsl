...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(Форма, НовыеПользовательскиеНастройкиКД) Экспорт
	...
	Если Параметры.Свойство("УспешныеТесты") Тогда
		ПараметрПоНастройкам(ПользовательскиеНастройки, "УспешныеТесты").Значение = Параметры.УспешныеТесты;
	КонецЕсли;
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НастройкиОтчета.Структура.ИдентификаторПользовательскойНастройки = "РасшифровкаОшибок" Тогда
		...
		ДобавитьПоляВРасшифровку.Добавить("Дубликат");
