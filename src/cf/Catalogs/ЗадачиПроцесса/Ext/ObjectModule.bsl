...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("СогласованиеРесурсовЗадач") Тогда
		РегистрыСведений.ПротоколСогласованияРесурсов.ОтразитьИзмененияПриЗаписиЗадачи(Ссылка, ДополнительныеСвойства.СогласованиеРесурсовЗадач);
	КонецЕсли;
