...
Процедура ПриПолученииДанныхФайла(ЭлементДанных, ПолучениеЭлемента)
	...
	ИначеЕсли ТипПолучаемогоОбъекта = Тип("РегистрСведенийНаборЗаписей.ЭтапыПроцесса")
		Или ТипПолучаемогоОбъекта = Тип("РегистрСведенийНаборЗаписей.ИтогиСогласованияЗадачРесурсов")
		...
		ИначеЕсли ТипПолучаемогоОбъекта = Тип("РегистрСведенийНаборЗаписей.ИтогиСогласованияЗадачРесурсов") Тогда
...
Функция РеквизитыРассинхронизацииПроектов()
	...
	Результат.Вставить("ПользовательАвторСообщенийПоОшибкам",                   Справочники.Пользователи.ПустаяСсылка());
