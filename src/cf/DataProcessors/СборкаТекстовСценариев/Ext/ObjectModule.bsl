...
// 
Функция ДанныеНастроекСценариевИзТекстовыхДанных(ДанныеКаталогаСценариев, ДанныеЭталонныхБД, ДанныеСценариев) Экспорт
	...
	Для Каждого Элем Из ДанныеКаталогаСценариев Цикл
		...
		Если НРег(Элем.ДанныеФайлаYaml["ТипФайла"]) = "настройкатеста" Тогда
			...
			СтрокаДанныеНастроек.UID                 = Элем.ДанныеФайлаYaml["ДанныеТеста"]["UID"];
...
//  ДанныеСценариев - Тип - ТаблицаЗначений.
// 
Функция ДанныеНастроекПроцессовИзТекстовыхДанных(ДанныеКаталогаПроцессов, ДанныеЭталонныхБД, ДанныеСценариев, ДанныеПроцессов) Экспорт
